...
final class UnusPay_WC_Payments_Block_Arbitrum extends AbstractPaymentMethodType {

	private $gateway;

	public $name = UnusPay_WC_Payments_Arbitrum_Gateway::GATEWAY_ID;

	public function initialize() {
		$this->gateway = new UnusPay_WC_Payments_Arbitrum_Gateway();
		$this->settings = array(
